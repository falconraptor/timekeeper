...
public class optionsdialog extends JFrame{
    ...
    private JPanel panel1() {
        colors.addActionListener(new ActionListener() {public void actionPerformed(ActionEvent evt) {rc.appear();}});
        background.addActionListener(new ActionListener() {public void actionPerformed(ActionEvent evt) {animatedbackground=!animatedbackground;}});
        urltext.getDocument().addDocumentListener(new DocumentListener() {
            public void changedUpdate(DocumentEvent e) {withinsecs=0;}
            public void removeUpdate(DocumentEvent e) {withinsecs=0;}
            public void insertUpdate(DocumentEvent e) {withinsecs=0;}
        });
        trans.addActionListener(new ActionListener() {public void actionPerformed(ActionEvent evt) {transparent=!transparent;}});
    ...
    public void warn() {
        ...
        if (urltext.getText().equals("resources\\images\\matrix.gif")&&(getResult()>2256481||getResult()==-1))  urltext.setText("a");
    ...
    public long getResult() {try{return new File("resources\\images\\matrix.gif").length();}catch(Exception e){System.err.println(e);return -1;}}
}